<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Details.aspx.cs" Inherits="Admin_Purchases_Details" %>
                            ...
                            <asp:ListView ID="lvOrders" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>Php<%# Eval("Price", "{0: #,###.00}") %></td>
                                        <td>
                                            <%# Eval("Quantity") %>
                                        </td>
                                        <td>P<%# Eval("Amount", "{0: #,###.00}") %></td>
                                        <td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-8">
                            <asp:LinkButton ID="btnApprove" runat="server" class="btn btn-success" OnClientClick='return confirm("Approve order?");'>
                        <i class="fa fa-thumbs-up"></i> Approve
                            </asp:LinkButton>
                            <asp:LinkButton ID="btnReject" runat="server" class="btn btn-danger" OnClientClick='return confirm("Reject order?");'>
                        <i class="fa fa-thumbs-down"></i> Reject
                            </asp:LinkButton>
                            <a href="Default.aspx" class="btn btn-info">Back to Orders
                            </a>
                        </div>
                    </div>
                </div>
